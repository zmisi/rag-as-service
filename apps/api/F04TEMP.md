...
> **Status:** superseded (2026-07-22). Use `document_sections` + section-aware leaf chunks per [F04 spec](../../docs/specs/phase1/features/F04-doc-ingestion.md).
...
Local e2e after publish: ensure `AUTO_MIGRATE=true`, optional `INGEST_SYNC_ON_PUBLISH=true`, then chat with a indexed `.txt` / `.md` doc.
