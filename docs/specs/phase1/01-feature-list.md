...
| F02 | Email 登录与会话 | `review` | `lxzxai.com`、`{subdomain}.lxzxai.com` | F01 | [F02-email-auth.md](features/F02-email-auth.md) |
...
| F05 | 会话列表与归档 | `approved` | `{subdomain}.lxzxai.com` | F02 | [F05-conversations.md](features/F05-conversations.md) |
